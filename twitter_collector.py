    ...
    def _generate_reply_comment(self, post_text: str, username: str = "") -> str:
        ...
        prompts = [
            (
                ...
                "Make it funny, interesting, hype, punchy, playful, and internet-native depending on the post. "
                "Use 4 to 10 words only. "
                "No hashtags. No quotation marks. No markdown. "
                "No role-speech, no formal tone, no boring summary, and no generic filler. "
                "Avoid repeating the headline. "
                "The reply must clearly relate to the real topic of the post. "
                "Avoid stiff or lazy comments like 'Iran gonna be mad'. "
                "A little slang is good if natural: bro, nah, yeah, wild, crazy, cooked, lol. "
            ...
            (
                ...
                "Sound human, casual, funny, interesting, hype, and internet-native, never formal. "
                "Each reply must be 4 to 8 words. "
                "Do not restate the headline. "
                "Keep the reply clearly tied to the topic. "
                "No hashtags. No quotes. No markdown. "
                "Avoid flat obvious comments. "
            ...
            (
                ...
                "Keep them short, punchy, funny, interesting, slangy, and different. "
                "They must clearly relate to the topic of the post. "
                "No hashtags. "
